        ...
        <ul class="flex items-center flex-shrink-0 space-x-6">
          ...
          <li class="relative" x-data="{ isProfileMenuOpen: false }">
            <div class="flex items-center space-x-4">
              @php
                  $profilePicture = Auth::user()->profile_picture ? asset('storage/' . Auth::user()->profile_picture) : asset('storage/public/profiles/default.png');
              @endphp
              <!-- Nama Pengguna -->
              <span class="text-sm font-medium text-gray-700">{{ Auth()->user()->usernama }} </span>
              <!-- Profile Pengguna -->
